            ...
            steps {
                ...
                withCredentials([string(credentialsId: 'SERVER', variable: 'SERVER')]) {
                    ...
                    withCredentials([
                        ...
                        sh "echo 'Um@sh1manna1' | ssh -o StrictHostKeyChecking=no -i $PEM_FILE azureuser@$SERVER 'cd /home/azureuser/arbicloud && git pull && echo \"Um@sh1manna1\" | sudo -S docker-compose build && sudo -S docker-compose up -d'"
